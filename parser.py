...
def parse_dados(bloco: str):
    print("[DEBUG] Bloco recebido: " + bloco[:150])
    bloco = bloco.strip()
    if not bloco:
    ...
    print("[DEBUG] is_alarme=" + str(is_alarme) + " | is_ligando=" + str(is_ligando))
    ...
    if is_alarme:
        ...
        if '|' in bloco:
            ...
            local = "DESCONHECIDO"
        print("[DEBUG] Local extraído: " + local)
        ...
        print("[DEBUG] SMS enviado - retornando None")
        return None
